::  prelude: compile the abbreviated Hoon prelude from Nockchain
::
...
::    benchmark.  The shipped prelude.noun holds Hoon %135 from Vere 4.3's
::    ivory pill; desk/bar/tests.json records its hashes.
::
::    Source: zorp-corp/nockchain hoon/common/hoon.hoon, Hoon %138.
::
/*  src  %hoon  /bar/src/hoon-138/hoon
=>  [cmp=..ride src=`@t`src]
:-  .
!=  (ride:cmp %noun src)
